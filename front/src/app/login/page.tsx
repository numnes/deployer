    ...
    <div className="flex min-h-screen items-center justify-center bg-[#2b2e33] p-6">
      <div className="w-full max-w-md">
        ...
        <div className="card p-5">
          ...
          <p className="page-subtitle">Faça login para gerenciar instâncias de preview.</p>
          <div className="h-4" />
          ...
          >
            <label className="mb-1.5 block text-sm text-[#b8bcc4]">E-mail</label>
            <input className="input" name="email" type="email" required />
            <div className="h-3" />
            <label className="mb-1.5 block text-sm text-[#b8bcc4]">Senha</label>
